...
Store.prototype.create = function(object) {
  var self = this;
  return self.db.collection(self.datasetId).insertOne(object).catch(function(err) {
    return self.handleError(undefined, err);
  });
};
...
Store.prototype.update = function(object) {
  ...
  return new Promise(function(resolve, reject) {
    return self.db.collection(self.datasetId).replaceOne(query, object).catch(function(err) {
      return reject(err);
